...
2. 通过exe直接下载
    ```bash
    XstreamDL-CLI_v1.2.5.exe --b64key oKi/hwKVuLveo/hISX1PQw== --hexiv b3d5ca56926d49d8e96b70aa5c7b358e --name 第一节总论 https://hls.videocc.net/d06ae002cb/2/d06ae002cb4a0bed78fb912c874fdbb2_2.m3u8
    ```
...
```bash
version 1.2.5, A downloader that download the HLS/DASH stream.
...
```bash
pyinstaller -i logo.ico -n XstreamDL-CLI_v1.2.5 -F XstreamDL_CLI\__main__.py
```
